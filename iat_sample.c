...
void run_iat(const char* audio_file, const char* session_begin_params)
{
	...
	printf("%s\n",rec_result);
	printf("=============================================================\n");
	FILE *fp=fopen("/home/pi/Documents/vs_code/text.txt","w");
	fputs(rec_result,fp);
	fclose(fp);
...
int main(int argc, char* argv[])
{
	...
	*/
	...
	// 	printf("上传用户词表成功\n");
	// }
	run_iat("/home/pi/Documents/vs_code/temp.wav", session_begin_params); //iflytek02音频内容为“中美数控”；如果上传了用户词表，识别结果为：“中美速控”。
exit:
